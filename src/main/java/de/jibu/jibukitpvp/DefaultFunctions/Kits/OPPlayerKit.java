...
public class OPPlayerKit {


    public static void GivePlayerOPKit(Player p) {
        ...
        p.getInventory().setItem(37, new ItemBuilder(Material.NETHERITE_LEGGINGS).addEnchant(Enchantment.PROTECTION_EXPLOSIONS, 4).addEnchant(Enchantment.DURABILITY, 3).addEnchant(Enchantment.MENDING, 1).getItemStack());
        ...
        p.getInventory().addItem(new ItemBuilder(Material.END_CRYSTAL, 64).getItemStack());
        ...
        p.getInventory().addItem(new ItemBuilder(Material.CROSSBOW, 1).addEnchant(Enchantment.MULTISHOT, 3).addEnchant(Enchantment.QUICK_CHARGE, 3).addEnchant(Enchantment.DURABILITY, 3).addEnchant(Enchantment.MENDING, 1).getItemStack());
        ...
        p.getInventory().addItem(new ItemBuilder(Material.OBSIDIAN, 64).getItemStack());
        p.getInventory().addItem(new ItemBuilder(Material.ENDER_PEARL, 16).getItemStack());
        p.getInventory().addItem(new ItemBuilder(Material.ENDER_PEARL, 16).getItemStack());
        p.getInventory().addItem(new ItemBuilder(Material.TOTEM_OF_UNDYING, 1).getItemStack());
        p.getInventory().addItem(new ItemBuilder(Material.TOTEM_OF_UNDYING, 1).getItemStack());
        p.getInventory().addItem(new ItemBuilder(Material.TOTEM_OF_UNDYING, 1).getItemStack());
        p.getInventory().addItem(new ItemBuilder(Material.GLOWSTONE, 64).getItemStack());
        p.getInventory().addItem(new ItemBuilder(Material.RESPAWN_ANCHOR, 64).getItemStack());
        p.getInventory().addItem(new ItemBuilder(Material.TIPPED_ARROW, 64).addPotionEffect(new PotionEffect(PotionEffectType.SLOW_FALLING, 30*20, 0)).setName("§fArrow of Slow Falling").setPotionColor(Color.WHITE).getItemStack());
